...
const commonPlants = [
  {
    ...
    light: "low",
    water: "moderate",
    temperature: JSON.stringify({ ideal: "18-24°C", min: "15°C", max: "30°C" }),
    humidity: JSON.stringify({ ideal: "40-60%", min: "30%", max: "70%" }),
    soil: "well-draining potting mix",
    growthRate: "medium",
    matureSize: JSON.stringify({ height: "20-30cm", spread: "30-50cm" }),
    difficulty: 2,
    ...
    toxicity: "non-toxic",
    benefits: JSON.stringify(["air-purification", "easy-care", "pet-friendly"]),
  ...
  },
  {
    ...
    light: "full-sun",
    water: "minimal",
    temperature: JSON.stringify({ ideal: "21-27°C", min: "10°C", max: "35°C" }),
    humidity: JSON.stringify({ ideal: "20-40%", min: "10%", max: "50%" }),
    soil: "cactus mix",
    growthRate: "slow",
    matureSize: JSON.stringify({ height: "10-30cm", spread: "5-20cm" }),
    difficulty: 1,
    ...
    toxicity: "non-toxic",
    benefits: JSON.stringify(["drought-resistant", "low-maintenance", "decorative"]),
  ...
  },
  {
    ...
    light: "medium",
    water: "moderate",
    temperature: JSON.stringify({ ideal: "18-24°C", min: "13°C", max: "27°C" }),
    humidity: JSON.stringify({ ideal: "40-60%", min: "30%", max: "70%" }),
    soil: "well-draining potting mix",
    growthRate: "medium",
    matureSize: JSON.stringify({ height: "30-60cm", spread: "30-60cm" }),
    difficulty: 2,
    ...
    toxicity: "non-toxic",
    benefits: JSON.stringify(["air-purification", "easy-propagation", "pet-friendly"]),
  ...
  },
  {
    ...
    light: "partial-sun",
    water: "frequent",
    temperature: JSON.stringify({ ideal: "18-24°C", min: "15°C", max: "27°C" }),
    humidity: JSON.stringify({ ideal: "50-70%", min: "40%", max: "80%" }),
    soil: "moist, well-draining soil",
    growthRate: "fast",
    matureSize: JSON.stringify({ height: "30-90cm", spread: "30-60cm" }),
    difficulty: 2,
    ...
    toxicity: "non-toxic",
    benefits: JSON.stringify(["culinary", "fragrant", "medicinal"]),
  ...
  },
  {
    ...
    light: "partial-sun",
    water: "minimal",
    temperature: JSON.stringify({ ideal: "18-25°C", min: "5°C", max: "35°C" }),
    humidity: JSON.stringify({ ideal: "30-50%", min: "20%", max: "60%" }),
    soil: "cactus/succulent mix",
    growthRate: "slow",
    matureSize: JSON.stringify({ height: "10-30cm", spread: "10-30cm" }),
    difficulty: 1,
    ...
    toxicity: "non-toxic",
    benefits: JSON.stringify(["drought-resistant", "decorative", "low-maintenance"]),
    ...
    if (plant) {
      await prisma.plantProblem.create({
        data: {
          ...
          symptoms: JSON.stringify(problem.symptoms || []),
          causes: JSON.stringify(problem.causes || []),
    ...
    if (plant) {
      await prisma.plantSeason.create({
        data: {
          ...
          tasks: JSON.stringify(season.tasks || []),
          careTips: JSON.stringify(season.careTips || [])
        }
      });
    }
  }
